...
const EmptyState: React.FC<EmptyStateProps> = ({ filter }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center select-none animate-fade-in">
      <div className="w-14 h-14 rounded-2xl weather-sheen flex items-center justify-center mb-4 border border-white/70">
      ...
      <p className="text-[var(--color-text-dim)] text-sm font-bold max-w-xs">
        {getMessage()}
      </p>
    </div>
  );
